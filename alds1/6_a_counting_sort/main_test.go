...
var countingSortTests = []struct {
	name string
	text string
	want string
}{
	{
		name: "should return sorted progression, that is worst case",
		text: "8\n8 7 6 5 4 3 2 1\n",
		want: "1 2 3 4 5 6 7 8",
	},
	{
		name: "should return sorted progression including duplicated values",
		text: "10\n2 2 2 1 1 5 5 9 1 1\n",
		want: "1 1 1 1 2 2 2 5 5 9",
	},
	{
		name: "should retrun sorted progression from large input",
...
func TestCountingSort(t *testing.T) {
	for _, testcase := range countingSortTests {
		t.Log(testcase.name)
